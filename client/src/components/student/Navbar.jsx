...
const Navbar = () => {
  ...
  return (
    <div className={`flex items-center justify-between px-4 sm:px-10 md:px-14 lg:px-36 border-b border-gray-500 py-4 ${isCoursesListPage ? 'bg-white' : 'bg-cyan-100/70'}`}>
      ...
      <a href="https://code-reviewer-frontend-virid.vercel.app/" className='py-2 px-4 bg-blue-700 rounded-full text-white hover:scale-0.5' target="_blank">Code Reviewer</a>
